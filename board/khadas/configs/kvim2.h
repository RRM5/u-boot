...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"bootdisk=ramdisk\0" \
	"initargs=" \
		"root=/dev/rootfs rootflags=data=writeback rw logo=osd1,loaded,0x3d800000,1080p60hz vout=1080p60hz,enable hdmimode=1080p60hz console=ttyS0,115200n8 console=tty0 no_console_suspend consoleblank=0 fsck.repair=yes net.ifnames=0\0" \
	"storeargs="\
	...
	"wol_init="\
		...
		"fi;\0"\
        "storeboot="\
            "ext4load mmc 1:5 1080000 uImage; ext4load mmc 1:5 10000000 uInitrd; ext4load mmc 1:5 20000000 kvim2.dtb;bootm 1080000 10000000 20000000"\
            "\0"\
